...
const NewHotel = () => {
  ...
  const handleSelect = (e) => {
    ...
    // e.target.selectedOptions gives as HTMLCollection
    // have to be convert to Array
      ...
      const list = await Promise.all(
        Object.values(files).map(async (file) => {
          ...
          const uploadRes = await axios.post(
            'https://api.cloudinary.com/v1_1/dyeb319gw/image/upload',
            data
          )
        ...
        // as our files are objects it have to be converted to array format
        // utilized of Object.values
